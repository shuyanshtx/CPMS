  ...
  return (
    <Layout>
      <Header>
        ...
        <text className="title">CPMS</text>
      </Header>
      <Content>
        <Router>
          <Switch>
          ...
          <Switch>
            ...
            <Route
              ...
              exact
              component={CalendarResident}
            />
            <Route path="/resident/account" exact component={AccountResident} />
            <Route
              path="/resident/bookamenity"
              exact
              component={BookAmenityResident}
            />
            <Route
              path="/resident/reservations"
              exact
              component={ReservationsResident}
            />
            <Route
              path="/resident/maintenance"
              exact
              component={MaintenanceResident}
            />
            <Route
              path="/resident/messages"
              exact
              component={MessagesResident}
            />
          </Switch>
          <Switch>
